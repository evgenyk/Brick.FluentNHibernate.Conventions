...
{
    public class MappingTestsNamspacedConvention
    {
        [Fact]
        public void TestMappingFromANamespace()
        {
            var configuration = FluentConfiguation.CreateBasedOn<NamespacedConfigurationOf<Account>>("Data Source=:memory:;Version=3;New=True;", DatabaseDialect.Sqlite);
